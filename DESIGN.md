...
현재 도화지 상세 페이지에 적용되어 있으며, 차분한 제품 페이지를 확장할 때 우선 검토하는 기본 팔레트다.
...
| --- | --- | --- |
| Link Flower | Hiorio의 이름과 제작자 관점이 먼저 보이는 작업 인덱스 | 페이지 체계명은 푸터와 문서에서만 보조적으로 사용 |
...
| TimeFlower | 앱 빌드 설정의 `assets/images/icon.png` | `1.0.0` |
